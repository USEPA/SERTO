...
class BaseflowAnalysis:
    """
    This class performs baseflow analysis
    """

    @staticmethod
    def chapman_and_maxwell(data: NDArray[np.float64], a: float = 0.976, initial_baseflow: float = 0.0):
        """
    ...
    @staticmethod
    def eckhardt(data: NDArray[np.float64], a: float = 0.9982, bfi: float = 0.524, initial_baseflow: float = 0.0):
        """
    ...
    def stewart(
        ...
        :param data: numpy array of measured flows
        :param k: recession constant (0.009 recommended)
        :param f: recession constant (0.009 recommended)
        :param initial_baseflow: initial baseflow value
        :return: numpy array of baseflow
        """
        length = data.shape[0]
